...
// 感染半径
parameterData[0] = { name: 'infectionRadius', div: '感染半径 @@@', initValue: 0.1, max: 0.4, min: 0.01, step: 0.001, color: '10, 100%, 63%', transform: 'parseFloat(#paraValue#)', requiresReset: false, runFAtEnd: '' }
// 感染几率
parameterData[1] = { name: 'probabilityofInfection', div: '感染概率 @@@%', initValue: 6, max: 100, min: 0, step: 0.01, color: '10, 100%, 63%', transform: 'parseFloat(#paraValue#)/100', requiresReset: false, runFAtEnd: '' }
// 初感染者
divAdjust = ' 初始感染率 @@@% <font style="color:grey; font-size: 1.2vmax;"></font>'
...
// 感染持续时间
parameterData[3] = { name: 'infectionTime', div: '感染持续 @@@ 天', initValue: 25, max: 100, min: 1, step: 1, color: '10, 100%, 63%', transform: 'parseInt(#paraValue#)', requiresReset: false, runFAtEnd: '' }
// 感染多久后隔离
parameterData[4] = { name: 'quarantineAfter', div: '一个人感染 @@@ 天后开始隔离', initValue: 10, max: 100, min: 1, step: 1, color: '10, 100%, 63%', transform: 'parseInt(#paraValue#)', requiresReset: false, runFAtEnd: '' }
// 疫情开始后多久开始隔离
parameterData[5] = { name: 'startQ', div: '疫情 @@@ 天后开始启用隔离区', initValue: 2, max: 100, min: 0, step: 1, color: '10, 100%, 63%', transform: 'parseInt(#paraValue#)', requiresReset: false, runFAtEnd: '' }
// 粒子数
